    ...
    <section className="py-20 px-4 md:px-8 lg:px-16">
      <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <motion.div
            ...
            className="relative"
        >
          <img src="https://images.unsplash.com/photo-1550745165-9bc0b252726a?q=80&w=800&auto=format&fit=crop" alt="Quality Product" className="w-full h-auto rounded-2xl filter saturate-150 contrast-110 object-cover aspect-[4/3]" />
